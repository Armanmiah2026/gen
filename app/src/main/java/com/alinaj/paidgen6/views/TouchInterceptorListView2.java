package com.alinaj.paidgen6.views;
...
import com.alinaj.paidgen6.R;

public class TouchInterceptorListView2 extends ListView {
...
//    private int mRemoveMode = -1;
    ...
    public TouchInterceptorListView2(Context context, AttributeSet attrs) {
        super(context, attrs);
        mTouchSlop = ViewConfiguration.get(context).getScaledTouchSlop();
        Resources res = getResources();
        mItemHeightNormal = res.getDimensionPixelSize(R.dimen.normal_height);
        mItemHeightHalf = mItemHeightNormal/mItemHeightNormal;
        ...
        if (mDragListener != null || mDropListener != null) {
            switch (ev.getAction()) {
                case MotionEvent.ACTION_DOWN:
                    ...
                    ImageView iv = item.getRootView().findViewById(R.id.network_drag);
...
//For coordinates location relative to the parent
                    ...
                    if (x > item.getWidth()-rectf.width()-25) {
...
//                    }
                    ...
                    if (itemnum >= 0) {
                        ...
                        if (y > mLowerBound) {
                            ...
                            if (getLastVisiblePosition() < getCount() - 1) {
                                speed = y > (mHeight + mLowerBound) / 2 ? 16 : 16;
                            } else {
                                speed = 1;
                            }
                        } else if (y < mUpperBound) {
                            // scroll the list down a bit
                            speed = y < mUpperBound / 2 ? -16 : -16;
    ...
    private void startDragging(Bitmap bm, int x, int y) {
        ...
        //v.setBackgroundResource(R.drawable.ic_drag);
